...
// The static properties - ceil and floor have been declared for you.
// You can declare more if you want.
// If the element is largest ceil will be largest integer value (32 bits),
// if element is smallest floor will be smallest integer value
#include <iostream>
#include <vector>
#include <stack>
#include <string>
