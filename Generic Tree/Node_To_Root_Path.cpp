...
// The function is expected to return in form of linked list the path from element to root,
// if the element with data is found.
#include <iostream>
#include <vector>
#include <stack>
#include <string>
...
int main()
{
    ...
    vector<int> list = nodeToRoothPath(root, key);
    for (int &e : list)
    {
        cout << e << " ";
    }
