...
// 2. You are required to complete the body of mergeSort function.
// The function is static and is passed the head and tail of an unsorted list.
...
int main()
{
    ...
    LinkedList shorted = LinkedList::mergeSort(l1.head, l1.tail);
    shorted.display();
    l1.display();
    return 0;
}