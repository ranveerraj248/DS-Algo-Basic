...
// The function is expected to print pre order, in order and post order of the tree in separate lines (first pre, then in and finally post order).
// All elements in an order must be separated by a space.
#include <iostream>
#include <string>
#include <vector>
#include <algorithm>
